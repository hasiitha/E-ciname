...
<h1><b><a href="login.php">Customer login</a><br><br><br>

<a href="login.php">Administrator login</b></a></h1>
...
<footer>
	...
	<div class="footer_menu">
		<ul>
			<li><a class="a1" href="contactUs.php">Contact Us</a></li>
			<li><a class="a1" href="registration.php">Register</a></li>
			<li><a class="a1" href="Home.php">Home</a></li>
			<li><a class="a1" href="movies.php">Movies</a></li>
			<li><a class="a1" href="theater.php">Theatres</a></li>
			<li><a class="a1" href="tickets.php">Book Tickets</a></li>
		</ul>
